...
/obj/item/paper/guides/jobs/engineering/bsa
	...
	* 1 glass sheet
	...
	11. Construct a computer terminal in the same room as the BSA assembly, make sure they draw power from the same APC or ask the Site Foreman to check the blueprints for you.
