...
<<<<<<< HEAD
	/datum/admins/proc/togglelooc, // NON-MODULAR CHANGES: toggle LOOC verb  (this list isn't touched ever anyways)
=======
...
>>>>>>> acd43427c982 (List Them Out - A Modern Revision On Extracting Global Lists (#70080))
	)
