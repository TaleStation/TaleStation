...
/mob/living/basic/spider/giant/tangle/Initialize(mapload)
	...
	AddComponent(/datum/component/healing_touch,\
		...
		interaction_key = DOAFTER_SOURCE_SPIDER,\
<<<<<<< HEAD:code/modules/mob/living/basic/space_fauna/spider/giant_spider/giant_spider_variants.dm
...
>>>>>>> 497f18ea3215f (Spiders don't automatically grant an antag datum (#77523)):code/modules/mob/living/basic/space_fauna/spider/giant_spider/giant_spiders.dm
