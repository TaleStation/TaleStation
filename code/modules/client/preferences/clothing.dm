/proc/generate_values_for_underwear(list/accessory_list, list/icons, color)
	...
	for (var/icon in icons)
		lower_half.Blend(icon('talestation_modules/icons/mob/human_parts_greyscale_js.dmi', icon), ICON_OVERLAY) // NON-MODULAR CHANGE - Reverts back to our GS dmi
...
/datum/preference/choiced/undershirt/init_possible_values()
	var/icon/body = icon('talestation_modules/icons/mob/human_parts_greyscale_js.dmi', "human_r_leg") // NON-MODULAR CHANGE START - Uses our GS dmi
	...
	body.Blend(icon('talestation_modules/icons/mob/human_parts_greyscale_js.dmi', "human_chest_m"), ICON_OVERLAY) // NON-MODULAR CHANGE END
