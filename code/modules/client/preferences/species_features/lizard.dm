/proc/generate_lizard_side_shots(list/sprite_accessories, key, include_snout = TRUE)
	...
	var/icon/lizard = icon('jollystation_modules/icons/mob/human_parts_greyscale_js.dmi', "lizard_head_m", EAST) // NON-MODULAR CHANGE - Uses our GS dmi
...
/datum/preference/choiced/lizard_body_markings/init_possible_values()
	...
	var/icon/lizard = icon('jollystation_modules/icons/mob/human_parts_greyscale_js.dmi', "lizard_chest_m") // NON-MODULAR CHANGE - Uses our GS dmi
