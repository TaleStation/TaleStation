...
/datum/unit_test/heretic_knowledge/Run()
	...
	var/list/blacklist = list(/datum/eldritch_knowledge/spell,/datum/eldritch_knowledge/curse,/datum/eldritch_knowledge/final,/datum/eldritch_knowledge/summon,/datum/eldritch_knowledge/no_ascension,/datum/eldritch_knowledge/no_sacrifices) // NON-MODULE CHANGE
