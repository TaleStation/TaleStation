/datum/job/atmospheric_technician
	...
	exp_requirements = 180 // NON-MODULAR CHANGE
	exp_required_type = EXP_TYPE_ENGINEERING // NON-MODULAR CHANGE
	exp_granted_type = EXP_TYPE_ENGINEERING // NON-MODULAR CHANGE
