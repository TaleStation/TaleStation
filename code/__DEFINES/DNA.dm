...
#define DNA_TAJARAN_SNOUT 18 // NON-MODULAR CHANGE: Tajarns
#define DNA_TAJARAN_MARKINGS 19 // NON-MODULAR CHANGE: Tajarns
#define DNA_TAJARAN_EARS 20 // NON-MODULAR CHANGE: Tajarns
#define DNA_TAJARAN_TAIL 21 // NON-MODULAR CHANGE: Tajarns
...
#define ORGAN_SLOT_EXTERNAL_HEAD_TENTACLES "head_tentacles" // NON-MODULAR CHANGE
