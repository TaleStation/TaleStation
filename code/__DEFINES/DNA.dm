...
#define DNA_TAJARAN_SNOUT_COLOR 8 // NON-MODULAR CHANGES: TAJARAN
...
>>>>>>> c8b89a6e21c6 (Stomach get_availability() now checks for NO_HUNGER instead of broken trait that no mobs have. (#69674))
