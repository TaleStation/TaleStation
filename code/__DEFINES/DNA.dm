...
#define DNA_TAJARAN_SNOUT_BLOCK 17
#define DNA_TAJARAN_MARKINGS_BLOCK 18
#define DNA_TAJARAN_TAIL_BLOCK 19
#define DNA_AVIAN_TAIL_BLOCK 20
#define DNA_AVIAN_BEAK_BLOCK 21
#define DNA_TAJARAN_EARS_BLOCK 22
#define DNA_AVIAN_CREST_BLOCK 23

#define DNA_FEATURE_BLOCKS 24 // MAKE SURE TO INCREASE THIS IF YOU ADD MORE FEATURES!! also it needs to be value + 1, its bugged don't ask me why
