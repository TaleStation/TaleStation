...
// Science
#define JOB_ORDNANCE_TECH "Ordnance Tech"
#define JOB_XENOBIOLOGIST "Xenobiologist"

// Positioning
#define JOB_DISPLAY_ORDER_ASSET_PROTECTION 1
#define JOB_DISPLAY_ORDER_BRIDGE_OFFICER 2
#define JOB_DISPLAY_ORDER_ORDNANCE_TECH 28
#define JOB_DISPLAY_ORDER_XENOBIOLOGIST 29
