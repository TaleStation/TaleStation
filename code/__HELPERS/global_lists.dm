...
/proc/make_datum_references_lists()
	...
	init_sprite_accessory_subtypes(/datum/sprite_accessory/head_tentacles, GLOB.head_tentacles_list) //NON-MODULAR CHANGES: Skrell
	...
	init_sprite_accessory_subtypes(/datum/sprite_accessory/leg/avian_talon/left, GLOB.avian_talon_l_list) //NON-MODULAR CHANGES: Avians
	init_sprite_accessory_subtypes(/datum/sprite_accessory/leg/avian_talon/right, GLOB.avian_talon_r_list) //NON-MODULAR CHANGES: Avians
