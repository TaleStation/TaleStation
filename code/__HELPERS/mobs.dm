...
/proc/random_features()
	...
	if(!GLOB.head_tentacles_list.len) // NON-MODULAR CHANGES: Skrell head tentacles initialize
		init_sprite_accessory_subtypes(/datum/sprite_accessory/head_tentacles, GLOB.head_tentacles_list)
	if(!GLOB.tajaran_tail_list.len) // NON-MODULAR CHANGES: Tajaran tail initialize
	...
	if(!GLOB.avian_talon_l_list.len) // NON-MODULAR CHANGES: Avian left talon initialize
		init_sprite_accessory_subtypes(/obj/item/organ/external/leg/avian_talon/left_leg, GLOB.avian_talon_l_list)
	if(!GLOB.avian_talon_r_list.len) // NON-MODULAR CHANGES: Avian right talon initialize
		init_sprite_accessory_subtypes(/obj/item/organ/external/leg/avian_talon/right_leg, GLOB.avian_talon_r_list)
