/obj/machinery/light
	icon = 'jollystation_modules/icons/obj/lighting.dmi'
	overlay_icon = 'jollystation_modules/icons/obj/lighting_overlay.dmi'
...
/obj/machinery/light/proc/turn_on(trigger, play_sound = TRUE)
	...
	if(!matching)
		...
		if(rigged)
			...
			set_light(BR, PO, CO)
			if(play_sound)
				playsound(src.loc, 'jollystation_modules/sound/machines/lights/light_on.ogg', 65, 1)
