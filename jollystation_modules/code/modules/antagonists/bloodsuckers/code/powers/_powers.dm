/datum/action/bloodsucker
	...
	button_icon = 'jollystation_modules/code/modules/antagonists/bloodsuckers/icons/actions_bloodsucker.dmi'
	//This is the ICON_STATE for the background icon
	background_icon_state = "vamp_power_off"
	icon_icon = 'jollystation_modules/code/modules/antagonists/bloodsuckers/icons/actions_bloodsucker.dmi'
