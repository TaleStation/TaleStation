...
/datum/action/bloodsucker/targeted/tremere
	...
	button_icon = 'talestation_modules/icons/bloodsuckers/actions_tremere_bloodsucker.dmi'
	icon_icon = 'talestation_modules/icons/bloodsuckers/actions_tremere_bloodsucker.dmi'
