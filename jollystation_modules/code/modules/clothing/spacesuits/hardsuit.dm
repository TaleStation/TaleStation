...
/obj/item/clothing/suit/space/hardsuit/clownop
	...
	armor = list(MELEE = 10, BULLET = 10, LASER = 0, ENERGY = 0, BOMB = 5, BIO = 0, FIRE = 0, ACID = 0, WOUND = 0)
...
/obj/item/clothing/head/helmet/space/hardsuit/clownop
	...
	hardsuit_type = "syndi"
	armor = list(MELEE = 5, BULLET = 5, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 0, ACID = 0, WOUND = 0)
	on = TRUE
