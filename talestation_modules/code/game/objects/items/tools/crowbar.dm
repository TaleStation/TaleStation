// Modular crowbar access

/obj/item/crowbar
	icon = 'talestation_modules/icons/obj/tools.dmi'

/obj/item/crowbar/power
	lefthand_file = 'talestation_modules/icons/mob/inhands/tools_lefthand.dmi'
	righthand_file = 'talestation_modules/icons/mob/inhands/tools_righthand.dmi'
