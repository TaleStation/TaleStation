...
/datum/antagonist/bloodsucker/apply_innate_effects(mob/living/mob_override)
	...
	if(iscarbon(current_mob))
		var/mob/living/carbon/carbon_mob = current_mob
		carbon_mob.pain_controller.pain_modifier = 0.2 //hard set to 0.2
...
/datum/antagonist/bloodsucker/remove_innate_effects(mob/living/mob_override)
	...
	if(iscarbon(current_mob))
		var/mob/living/carbon/carbon_mob = current_mob
		carbon_mob.pain_controller.pain_modifier = initial(carbon_mob.pain_controller.pain_modifier)
...
/datum/antagonist/bloodsucker/greet()
	...
	owner.current.playsound_local(null, 'talestation_modules/sound/bloodsuckers/BloodsuckerAlert.ogg', 100, FALSE, pressure_affected = FALSE)
...
/datum/antagonist/bloodsucker/proc/break_masquerade()
	if(broke_masquerade)
		return
	owner.current.playsound_local(null, 'talestation_modules/sound/bloodsuckers/lunge_warn.ogg', 100, FALSE, pressure_affected = FALSE)
