...
/mob/living/carbon/proc/return_vamp_examine(mob/living/viewer)
	...
	if(viewer.mind.has_antag_datum(/datum/antagonist/vassal) in bloodsuckerdatum.vassals)
		...
		var/returnIcon = "[icon2html('talestation_modules/icons/bloodsuckers/vampiric.dmi', world, "bloodsucker")]"
		returnString += "\n"
...
/mob/living/carbon/proc/return_vassal_examine(mob/living/viewer)
	...
	if(vassaldatum?.master.owner == viewer.mind)
		...
		returnIcon = "[icon2html('talestation_modules/icons/bloodsuckers/vampiric.dmi', world, "vassal")]"
	// Am I someone ELSE'S Vassal?
		...
		returnIcon = "[icon2html('talestation_modules/icons/bloodsuckers/vampiric.dmi', world, "vassal_grey")]"
