	...
	spawn(10)
		...
		/*	if(HAS_TRAIT(target, TRAIT_MINDSHIELD))
			...
			var/list/torture_icons = list(
				"Accept" = image(icon = 'talestation_modules/icons/bloodsuckers/actions_bloodsucker.dmi', icon_state = "power_recup"),
...
/obj/structure/bloodsucker/bloodthrone
	...
	icon = 'talestation_modules/icons/bloodsuckers/vamp_obj_64.dmi'
	icon_state = "throne"
	buckle_lying = 0
	anchored = FALSE
	density = TRUE
...
/obj/structure/bloodsucker/bloodthrone/proc/GetArmrest()
	return mutable_appearance('talestation_modules/icons/bloodsuckers/vamp_obj_64.dmi', "thronearm")
