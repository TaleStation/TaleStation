...
/datum/examine_panel/ui_data(mob/user)
	...
	if(issilicon(holder))
		flavor_text = preferences.read_preference(/datum/preference/multiline_text/flavor_datum/silicon_flavor_text)
		ooc_notes += preferences.read_preference(/datum/preference/multiline_text/flavor_datum/ooc_notes)
