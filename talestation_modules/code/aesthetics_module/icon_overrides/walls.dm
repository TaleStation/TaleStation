...
/turf/closed/wall
	...
	smoothing_groups = SMOOTH_GROUP_WINDOW_FULLTILE + SMOOTH_GROUP_CLOSED_TURFS + SMOOTH_GROUP_WALLS
	canSmoothWith = SMOOTH_GROUP_WINDOW_FULLTILE + SMOOTH_GROUP_CLOSED_TURFS + SMOOTH_GROUP_WALLS
